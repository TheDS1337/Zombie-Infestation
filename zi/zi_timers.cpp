...
ZITimersCallback::Info ZITimersCallback::m_Info;
ZITimersCallback::Warning ZITimersCallback::m_Warning;
ZITimersCallback::Countdown ZITimersCallback::m_Countdown;
ZITimersCallback::StartMode ZITimersCallback::m_StartMode;
ZITimersCallback::AmbientSound ZITimersCallback::m_AmbientSound;
ZITimersCallback::TeamsRandomization ZITimersCallback::m_TeamsRandomization;
ZITimersCallback::BulletTime ZITimersCallback::m_BulletTime;
ZITimersCallback::Stats ZITimersCallback::m_Stats;
ZITimersCallback::SetModel ZITimersCallback::m_SetModel;
ZITimersCallback::RemoveProtection ZITimersCallback::m_RemoveProtection;
ZITimersCallback::Respawn ZITimersCallback::m_Respawn;
ZITimersCallback::ZombieGrowl ZITimersCallback::m_ZombieGrowl;
ZITimersCallback::ZombieBleed ZITimersCallback::m_ZombieBleed;
ZITimersCallback::ZombieUnfreeze ZITimersCallback::m_ZombieUnfreeze;

ResultType ZITimersCallback::Info::OnTimer(ITimer *timer, void *data)
{
...
void ZITimersCallback::Info::OnTimerEnd(ITimer *timer, void *data)
{
}

ResultType ZITimersCallback::Warning::OnTimer(ITimer *timer, void *data)
{
	ZIPlayer *player = nullptr;
...
void ZITimersCallback::Warning::OnTimerEnd(ITimer *timer, void *data)
{
}

ResultType ZITimersCallback::Countdown::OnTimer(ITimer *timer, void *data)
{
...
void ZITimersCallback::Countdown::OnTimerEnd(ITimer *timer, void *data)
{
}

ResultType ZITimersCallback::StartMode::OnTimer(ITimer *timer, void *data)
{	
...
void ZITimersCallback::StartMode::OnTimerEnd(ITimer *timer, void *data)
{	
}

ResultType ZITimersCallback::AmbientSound::OnTimer(ITimer *timer, void *data)
{
	...
	ZICore::m_pAmbientSoundTimer = timersys->CreateTimer(&ZICore::m_TimersCallback.m_AmbientSound, sound->duration + 0.2, sound, TIMER_FLAG_NO_MAPCHANGE);
	return Pl_Stop;
}

void ZITimersCallback::AmbientSound::OnTimerEnd(ITimer *timer, void *data)
{
	ZIPlayer *player = nullptr;
...
ResultType ZITimersCallback::TeamsRandomization::OnTimer(ITimer *timer, void *data)
{
	// Randomize the teams
...
void ZITimersCallback::TeamsRandomization::OnTimerEnd(ITimer *timer, void *data)
{
}
...
void ZITimersCallback::BulletTime::OnTimerEnd(ITimer *timer, void *data)
{
}

ResultType ZITimersCallback::Stats::OnTimer(ITimer *timer, void *data)
{
...
void ZITimersCallback::Stats::OnTimerEnd(ITimer *timer, void *data)
{
}

ResultType ZITimersCallback::SetModel::OnTimer(ITimer *timer, void *data)
{
	ZIPlayer *player = (ZIPlayer *) data;
...
void ZITimersCallback::SetModel::OnTimerEnd(ITimer *timer, void *data)
{
}

ResultType ZITimersCallback::RemoveProtection::OnTimer(ITimer *timer, void *data)
{
	ZIPlayer *player = (ZIPlayer *) data;
...
void ZITimersCallback::RemoveProtection::OnTimerEnd(ITimer *timer, void *data)
{
}

ResultType ZITimersCallback::Respawn::OnTimer(ITimer *timer, void *data)
{
	ZIPlayer *player = (ZIPlayer *) data;
...
void ZITimersCallback::Respawn::OnTimerEnd(ITimer *timer, void *data)
{
}

ResultType ZITimersCallback::ZombieGrowl::OnTimer(ITimer *timer, void *data)
{
	ZIPlayer *player = (ZIPlayer *) data;
...
void ZITimersCallback::ZombieGrowl::OnTimerEnd(ITimer *timer, void *data)
{
}

ResultType ZITimersCallback::ZombieBleed::OnTimer(ITimer *timer, void *data)
{
	ZIPlayer *player = (ZIPlayer *) data;
...
void ZITimersCallback::ZombieBleed::OnTimerEnd(ITimer *timer, void *data)
{
}

ResultType ZITimersCallback::ZombieUnfreeze::OnTimer(ITimer *timer, void *data)
{
	ZIPlayer *player = (ZIPlayer *) data;
...
void ZITimersCallback::ZombieUnfreeze::OnTimerEnd(ITimer *timer, void *data)
{
}