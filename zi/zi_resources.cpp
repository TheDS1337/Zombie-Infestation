...
{
	int m_BloodSprayModelIndex = -1;
	int m_BloodDropModelIndex = -1;
	int m_LaserModelIndex = -1;
	int m_BeamModelIndex = -1;
	int m_HaloModelIndex = -1;
	int m_GlowModelIndex = -1;
	int m_FireModelIndex = -1;
	int m_ExplosionModelIndex = -1;
	int m_GlassModelIndex[] = { -1 };
	...
	void Load()
	{
		...
		m_LaserModelIndex = g_pExtension->m_pEngineServer->PrecacheModel("materials/sprites/laserbeam.vmt", true);
