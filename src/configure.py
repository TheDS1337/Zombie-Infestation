...
builder.options.add_option('-s', '--sdks', default='csgo', dest='sdks', help='Build against specified SDKs; valid args are "all", "present", or comma-delimited list of engine names (default: %default)')
