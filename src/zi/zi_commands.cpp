...
#define MY_STEAM_ID ".dSssss"	// TODO

int ZICommands::m_Commander = 0;

ZICommands g_Commands;

ZIPlayer *ZICommands::FindTarget(const char *auth)
{
	int index = 0;
	char name[64];
...
bool ZICommands::OnPreLookAtWeaponCommand(ZIPlayer *player, const CCommand &args)
{
...
bool ZICommands::OnPreNightVisionCommand(ZIPlayer *player, const CCommand &args)
{
...
bool ZICommands::OnPreDropCommand(ZIPlayer *player, const CCommand &args)
{
...
bool ZICommands::OnPreBuyCommand(ZIPlayer *player, const CCommand &args)
{
...
bool ZICommands::OnClientSayCommand(ZIPlayer *player, CCommand &cmd)
{
...
void ZICommands::MakeHuman(ZIPlayer *target, ZIPlayer *admin)
{
	if( !target || !admin )
	{
		return;
...
void ZICommands::MakeZombie(ZIPlayer *target, ZIPlayer *admin)
{
	if( !target || !admin )
	{
		return;
...
void ZICommands::MakeSurvivor(ZIPlayer *target, ZIPlayer *admin)
{
	if( !target || !admin )
	{
		return;
...
void ZICommands::MakeSniper(ZIPlayer *target, ZIPlayer *admin)
{
	if( !target || !admin )
	{
		return;
...
void ZICommands::MakeNemesis(ZIPlayer *target, ZIPlayer *admin)
{
	if( !target || !admin )
	{
		return;
...
void ZICommands::MakeAssassin(ZIPlayer *target, ZIPlayer *admin)
{
	if( !target || !admin )
	{
		return;
...
void ZICommands::StartMultipleInfection(ZIPlayer *admin)
{
	if( !admin )
	{
		return;
...
void ZICommands::StartSwarm(ZIPlayer *admin)
{
	if( !admin )
	{
		return;
...
void ZICommands::StartPlague(ZIPlayer *admin)
{
	if( !admin )
	{
		return;
...
void ZICommands::StartArmageddon(ZIPlayer *admin)
{
	if( !admin )
	{
		return;
...
void ZICommands::StartAssassinsVSSnipers(ZIPlayer *admin)
{
	if( !admin )
	{
		return;
...
void ZICommands::StartNightmare(ZIPlayer *admin)
{
	if( !admin )
	{
		return;
